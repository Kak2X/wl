...
Act_StoveCanyonBossEyes:
	...
	; It doesn't matter here since there's no middle vertical section, but this
	; check here follows the broken pattern of the previous checks.
	; (the correct check would have been "jr   c, .eyesU")
